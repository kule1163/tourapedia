...
app.use("/uploads/postPhotos", express_1.default.static(__dirname + "/uploads/postPhotos"));
app.use("/uploads/profilePhotos", express_1.default.static(__dirname + "/uploads/profilePhotos"));
...
if (process.env.NODE_ENV === "production") {
    ...
    console.log(path_1.default.join(__dirname, "../my-app/build"));
    app.get("*", (req, res) => {
