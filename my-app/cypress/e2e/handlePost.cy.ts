describe("handle post", () => {
  ...
  it("like dislike post", () => {
    //like-dislike
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(1) > [data-testid="like"]'
    ).click();
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(1) > [data-testid="like"] > [data-testid="fill-like"]'
    ).should("be.visible");
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(2) > [data-testid="dislike"]'
    ).click();
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(1) > [data-testid="like"] > [data-testid="outline-like"]'
    ).should("be.visible");
    ...
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(2) > [data-testid="dislike"] > [data-testid="fill-dislike"]'
    ).should("be.visible");
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(2) > [data-testid="dislike"]'
    ).click();
    cy.get(
      ':nth-child(1) > .single-post-box > .like-container > :nth-child(2) > [data-testid="dislike"] > [data-testid="outline-dislike"]'
    ).should("be.visible");
  });
